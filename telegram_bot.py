...
class TelegramController:
    def __init__(self, config, broker, strategy, tx_lock=None, queue_ledger=None, strategy_rev=None):
        ...
        self.cmd_ticker = require_admin(self.cfg, self.commands_handler.cmd_ticker)
        self.cmd_mode = require_admin(self.cfg, self.commands_handler.cmd_mode)
        self.cmd_version = require_admin(self.cfg, self.commands_handler.cmd_version)
        self.cmd_queue = require_admin(self.cfg, self.commands_handler.cmd_queue)
        self.cmd_add_q = require_admin(self.cfg, self.commands_handler.cmd_add_q)
        self.cmd_clear_q = require_admin(self.cfg, self.commands_handler.cmd_clear_q)
        ...
        self.cmd_avwap = require_admin(self.cfg, self.commands_handler.cmd_avwap)
